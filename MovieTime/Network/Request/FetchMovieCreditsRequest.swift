...
struct FetchMovieCreditsRequest: NetworkRequestConvertible {
    ...
    init(movieId: String) {
        urlString = NetworkManager.shared.baseUrl + String(format: NetworkRequestType.movieCredits.urlPath, movieId)
    }
}
